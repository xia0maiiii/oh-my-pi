...
SHAPES = {
    "doc-8on16-bw": {"font": "8x13", "cellWidth": 8, "cellHeight": 16, "stretch": False, "variant": "bw",
                     "columns": 2, "lineRepeat": 1, "frameSize": SIZE, "frameTokenEstimate": 2900},
    "doc-8on16-sent": {"font": "8x13", "cellWidth": 8, "cellHeight": 16, "stretch": False, "variant": "sent",
                       "columns": 2, "lineRepeat": 1, "frameSize": SIZE, "frameTokenEstimate": 2900},
    "doc-8on16-sent-dim": {"font": "8x13", "cellWidth": 8, "cellHeight": 16, "stretch": False, "variant": "sent",
                           "columns": 2, "stopwordDim": True, "lineRepeat": 1, "frameSize": SIZE,
                           "frameTokenEstimate": 2900},
    "8on16-bw": {"font": "8x13", "cellWidth": 8, "cellHeight": 16, "stretch": False, "variant": "bw",
                 "lineRepeat": 1, "frameSize": SIZE, "frameTokenEstimate": 2900},
    "6x12-dim": {"font": "6x12", "cellWidth": 6, "cellHeight": 12, "variant": "bw", "stopwordDim": True,
                 "lineRepeat": 1, "frameSize": SIZE, "frameTokenEstimate": 3300},
    "8x13-bw": {"font": "8x13", "cellWidth": 8, "cellHeight": 13, "variant": "bw",
                "lineRepeat": 1, "frameSize": SIZE, "frameTokenEstimate": 3300},
    "8x8r-bw": {"font": "8x8", "cellWidth": 8, "cellHeight": 8, "variant": "bw",
...
def main() -> None:
    ...
    for b in range(0, len(questions), args.qpb):
        ...
        qa = cached(
            args.model, "qa-mono-prod", {"messages": messages, "effort": args.effort},
    ...
    rows_out = [
        {
            "model": args.model, "cond": cond, "pos_rel": q["pos_rel"], "q": q["q"], "answer": a,
    ...
    summary = {
        "cond": cond, "n": len(rows_out), "imgs": len(pngs),
