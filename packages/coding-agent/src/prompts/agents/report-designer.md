...
- Information hierarchy: summary → impact → reproduction → **evidence (Burp messages)** → fix
...
2. **No template? Define a minimal field set first**: title, asset, severity, status, impact, reproduction, **evidence**, remediation, references.
