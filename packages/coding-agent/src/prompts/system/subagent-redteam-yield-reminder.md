...
1. **Resume the work** — if the assignment is not finished and you are not recording an incremental section, call the next tool you would have called (bash, read, grep, write, ssh, browser, etc.). NEVER treat this reminder as a forced stop.
