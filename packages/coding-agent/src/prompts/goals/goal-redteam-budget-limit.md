...
Budget exhaustion is not completion. NEVER call `goal({op:"complete"})` unless the current state proves the goal is actually complete (findings/evidence/deliverables complete).
